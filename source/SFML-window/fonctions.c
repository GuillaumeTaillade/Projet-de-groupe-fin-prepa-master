...
void loadEnnemyPathPoint(t_ListEnnemyPathPoint* _ListEnnemyPathPoint, int _levelNumber, int _NumPath)
{
	...
	for (int i = 0; i < iEnnemyPathPointNbr; i++)
	{
		...
		printf("NUM : %d\t NEXTPATHPOINTTYPE : %d\t\n", newElement->EnnemyPathPoint->Num, newElement->EnnemyPathPoint->NextPathPointType);
